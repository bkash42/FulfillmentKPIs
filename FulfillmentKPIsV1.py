...
# Import the csv file into a DataFrame named fullDF
fullDF = pd.read_csv("Fulfillment KPI Data.csv", parse_dates=['Date'])

# Import list of Tax 1 Values
Tax1List = pd.read_csv('Taxonomy1List.csv')
